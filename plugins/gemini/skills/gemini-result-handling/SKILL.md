...
description: Internal guidance for presenting Gemini review and task output back to the user
...
- If the helper reports that setup is required, direct the user to `/gemini:setup` and do not improvise alternate flows.
